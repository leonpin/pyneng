...
addrlist2='{0:08b}{1:08b}{2:08b}{3:08b}'.format(*addrlist)[:mask]+'0'*(32-mask)
addrlist=[int(addrlist2[:8],2),int(addrlist2[8:16],2),int(addrlist2[16:24],2),int(addrlist2[24:32],2)]
