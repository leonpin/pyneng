...
def write_last_log_to_csv(source_log, output):
    ...
    with open(source_log) as f:
        ...
        data = sorted(list(reader), key=lambda x: convert_str_to_datetime(x['Last Changed']))
        new_data = {d['Email']:d for d in data}
...
if __name__ == "__main__":
    write_last_log_to_csv('mail_log.csv', 'new_log.csv')